...
sudo apt-get install -y xorg i3 lightdm alacritty vim network-manager gh zsh zsh-syntax-highlighting picom stow pulseaudio pavucontrol blueman libspa-0.2-bluetooth zip gpg ufw thunar
echo
